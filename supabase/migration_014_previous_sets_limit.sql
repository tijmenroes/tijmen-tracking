-- ============================================================
-- Migration 014 – Previous-session sets: cap 2 -> 5
-- Run in the Supabase SQL editor after migration_013.
--
-- The cap exists so a session with an absurd number of logged sets can't
-- flood the prefill; 5 covers every realistic set scheme. Keep this number in
-- sync with MAX_PREVIOUS_SETS in src/utils/sessionRefs.ts.
-- ============================================================
